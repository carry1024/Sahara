...
- (void)_handleAudioSessionInterruptionWithState:(UInt32)state
{
  ...
  if (state == kAudioSessionBeginInterruption) {
    ...
    [self _sendEvent:event_interruption_begin];
      ...
      [[NSNotificationCenter defaultCenter] postNotificationName:KNOTIFICATION_SONGEND object:nil];
  }
...
#pragma clang diagnostic pop
    ...
    [self _sendEvent:event_interruption_end
      ...
      [[NSNotificationCenter defaultCenter] postNotificationName:KNOTIFICATION_SONGRESTART object:nil];
  }
}
